...
// 车体目标角度环 PID
PID_t linear{.Kp = 1.62f,.Ki = 0.005f,.Kd = 0.41f,.MaxOut = 0.95*MAX_VELOCITY_LINEAR,.DeadBand = 0.005f,.Improve = NONE};
PID_t deg{.Kp = 2.20f,.Ki = 0.20f,.Kd = 0.2f,.MaxOut = MAX_VELOCITY_ANGULAR*0.75*180.0/M_PI,.DeadBand = 0.3f,.Improve = NONE};
