...
const std::array<OmniChassis::SpeedPidParam, OmniChassis::kOmniWheelCount>
  kOmniWheelPidParams = {
    OmniChassis::SpeedPidParam(35.0f, 0.0f, 0.05f, 8000.0f, 0.5f, NONE), // 左上
    OmniChassis::SpeedPidParam(35.0f, 0.0f, 0.05f, 8000.0f, 0.5f, NONE), // 右上
    OmniChassis::SpeedPidParam(35.0f, 0.0f, 0.05f, 8000.0f, 0.5f, NONE), // 左下
    OmniChassis::SpeedPidParam(35.0f, 0.0f, 0.05f, 8000.0f, 0.5f, NONE), // 右下
  };
}
