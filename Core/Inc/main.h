...
#define VALVE_LIFT_Pin GPIO_PIN_6
#define VALVE_LIFT_GPIO_Port GPIOG
#define PUMP_LIFT_Pin GPIO_PIN_7
#define PUMP_LIFT_GPIO_Port GPIOG
#define VALVE_PICK_Pin GPIO_PIN_8
#define VALVE_PICK_GPIO_Port GPIOG
